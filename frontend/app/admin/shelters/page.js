...
import { FiHome, FiPlus, FiSearch, FiEdit2, FiTrash2, FiX, FiMapPin } from 'react-icons/fi';
        ...
        >
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-gray-300">Manage emergency shelters and evacuation centers</p>
            </div>
            <button
